...
function insertUserData($id_number, $user_name, $full_name, $cbday, $cgender, $cparty, $cpartyimage) {
    ...
    $sql = "INSERT INTO images (id_number,   user_namefull_name, birthday, gender, party, partyimage) VALUES (?,?, ?,  ?, ?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_FILES["image"])) {
    ...
    $cpartyimage = isset($_FILES["cpartyimage"]["name"]) ? $_FILES["cpartyimage"]["name"] : "";
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        if (isset($_FILES["cpartyimage"]) && $_FILES["cpartyimage"]["error"] == UPLOAD_ERR_OK) {
            $cpartyimage = $_FILES["cpartyimage"]["name"];
            move_uploaded_file($_FILES["cpartyimage"]["tmp_name"], "uploads/" . $cpartyimage);
        } else {
            $cpartyimage = null;
        }

        insertUserData($id_number,$user_name, $full_name, $cbday, $cgender, $cparty,$image, $cpartyimage);
